 ...
 * ID:            %!uniqueid!%
 * Last Modified: 2019-11-25T12:32:15+00:00
 * File:          Block/Adminhtml/Source/Edit/Tab/Configuration.php
 * Copyright:     Copyright (c) XTENTO GmbH & Co. KG <info@xtento.com> / All rights reserved.
 */

namespace Xtento\StockImport\Block\Adminhtml\Source\Edit\Tab;

use Xtento\StockImport\Model\Source;

class Configuration extends \Xtento\StockImport\Block\Adminhtml\Widget\Tab implements \Magento\Backend\Block\Widget\Tab\TabInterface
{
    /**
    ...
    {
        $model = $this->_coreRegistry->registry('stockimport_source');
    ...
    protected function addFieldsForType($form, $type)
    {
        return $this->getLayout()->getBlockSingleton(
            '\Xtento\StockImport\Block\Adminhtml\Source\Edit\Tab\Type\\' . ucfirst($type)
        )->getFields($form);
    }
