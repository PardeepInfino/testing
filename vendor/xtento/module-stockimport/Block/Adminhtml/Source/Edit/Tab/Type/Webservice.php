 ...
 * File:          Block/Adminhtml/Source/Edit/Tab/Type/Webservice.php
    ...
    public function getFields(\Magento\Framework\Data\Form $form)
    {
        ...
        $fieldset->addField(
            ...
            [
                ...
                'note' => __(
                    'Please make sure the function you enter exists like this in the app/code/StockImport/Model/Source/Webservice.php file:<br>public function <i>yourFunctionName</i>() { ... }'
                ),
                'required' => true
            ]
        );
