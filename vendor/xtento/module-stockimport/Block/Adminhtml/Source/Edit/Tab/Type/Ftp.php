 ...
 * ID:            %!uniqueid!%
 * Last Modified: 2020-06-24T18:57:44+00:00
 * File:          Block/Adminhtml/Source/Edit/Tab/Type/Ftp.php
...
class Ftp extends AbstractType
{
    ...
    {
        $model = $this->registry->registry('stockimport_source');
        if ($type == 'FTP') {
        ...
        if ($type == 'FTP') {
            $fieldset->addField(
                ...
                [
                    ...
                    'name' => 'ftp_type',
                    'options' => [
                        \Xtento\StockImport\Model\Source\Ftp::TYPE_FTP => 'FTP',
                        \Xtento\StockImport\Model\Source\Ftp::TYPE_FTPS => 'FTPS ("FTP SSL")',
                    ],
                    'note' => __(
