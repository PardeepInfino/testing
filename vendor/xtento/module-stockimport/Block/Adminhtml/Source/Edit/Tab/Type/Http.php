 ...
 * File:          Block/Adminhtml/Source/Edit/Tab/Type/Http.php
    ...
    public function getFields(\Magento\Framework\Data\Form $form)
    {
        ...
        $fieldset->addField(
            ...
            [
                ...
                'note' => __(
                    'Please make sure the function you enter exists like this in the app/code/Xtento/StockImport/Model/Source/Http.php file:<br>public function <i>yourFunctionName</i>() { ... }'
                ),
                'required' => true
            ]
        );
