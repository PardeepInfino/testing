 ...
 * ID:            %!uniqueid!%
 * Last Modified: 2022-11-15T22:06:21+00:00
 * File:          Block/Adminhtml/Profile/Edit/Tab/Mapping/AbstractMapping.php
...
abstract class AbstractMapping extends AbstractFieldArray
{
    ...
    public function __construct(
        ...
        $profile = $this->registry->registry('stockimport_profile');
        ...
        $importFieldRenderer = $this->viewLayout->createBlock(
            'Xtento\StockImport\Block\Adminhtml\Profile\Edit\Tab\Mapping\Importfields'
        )->setNameInLayout('xtento_stockimport_profile_edit_mapping_importfields_' . $this->mappingId);
        ...
        if ($this->hasDefaultValueColumn) {
            $defaultValuesRenderer = $this->viewLayout->createBlock(
                'Xtento\StockImport\Block\Adminhtml\Profile\Edit\Tab\Mapping\Defaultvalues'
            )->setNameInLayout('xtento_stockimport_profile_edit_mapping_defaultvalues_' . $this->mappingId);
        ...
        $this->setTemplate('Xtento_StockImport::widget/mapper.phtml');
    }

    public function render(AbstractElement $element)
    {
        $this->setNameInLayout('xtento_stockimport_mapping_' . $this->mappingId);
