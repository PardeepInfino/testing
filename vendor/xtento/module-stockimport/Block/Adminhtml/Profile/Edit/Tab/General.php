...
class General extends \Xtento\StockImport\Block\Adminhtml\Widget\Tab implements \Magento\Backend\Block\Widget\Tab\TabInterface
{
    /**
    ...
    /**
     * @var \Xtento\StockImport\Model\System\Config\Source\Import\Entity
     */
    protected $importEntity;

    /**
     * @var \Xtento\StockImport\Model\System\Config\Source\Import\Processor
     */
     ...
     * @param \Xtento\StockImport\Model\System\Config\Source\Import\Entity $importEntity
     * @param \Xtento\StockImport\Model\System\Config\Source\Import\Processor $importProcessor
     * @param array $data
     */
    public function __construct(
        ...
        \Xtento\StockImport\Model\System\Config\Source\Import\Entity $importEntity,
        \Xtento\StockImport\Model\System\Config\Source\Import\Processor $importProcessor,
        array $data = []
    ) {
        $this->yesNo = $yesNo;
    ...
    protected function _prepareForm()
    {
        ...
        if (!$this->_coreRegistry->registry('stockimport_profile')
            || !$this->_coreRegistry->registry('stockimport_profile')->getId()
        ) {
            $fieldset->addField(
                'continue_button',
                'note',
