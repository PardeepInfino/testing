 ...
 * File:          Block/Adminhtml/Profile/Edit/Tab/Mapping/Importfields.php
...
class Importfields extends AbstractBlock
{
    public function _toHtml()
    {
        ...
        $html .= '&nbsp;<a href="#" onclick="helpPopup = $(\\\'' . $htmlId . '\\\').options[$(\\\'' . $htmlId . '\\\').selectedIndex].getAttribute(\\\'tooltip\\\'); if (helpPopup == null) { helpPopup = \\\'' . __(
            ...
            ) . '\\\'; } alert(helpPopup);" onmouseout=""><img src="' . $this->getViewFileUrl('Xtento_StockImport::images/help.png') . '" style="vertical-align: middle;"/></a>';
...
JS;
    ...
    public function _getImportFields()
    {
        ...
        foreach ($this->getImportFields() as $code => $field) {
            ...
            $html .= '<option value="' . $code . '"' . $disabled . $tooltipJs . $className . '>' . addslashes($field['label']) . '<\\/option>';
        }
        return $html;
    }
