 ...
 * File:          Controller/Adminhtml/Source/Save.php
...
class Save extends \Xtento\StockImport\Controller\Adminhtml\Source
{
    /**
    ...
    public function execute()
    {
        ...
        if ($postData = $this->getRequest()->getPost()) {
            ...
            try {
                ...
                $this->registry->register('stockimport_source', $model, true);
    ...
    {
        $source = $this->registry->registry('stockimport_source');
        $testResult = $this->_objectManager->create(
            '\Xtento\StockImport\Model\Source\\' . ucfirst($source->getType())
