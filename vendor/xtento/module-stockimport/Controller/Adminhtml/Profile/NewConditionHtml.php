 ...
 * File:          Controller/Adminhtml/Profile/NewConditionHtml.php
...
class NewConditionHtml extends \Xtento\StockImport\Controller\Adminhtml\Profile
{
    public function execute()
    {
        ...
        $this->registry->register('stockimport_profile', $profile);
