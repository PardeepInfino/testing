 ...
 * File:          Model/Processor/Mapping/AbstractConfiguration.php
...
abstract class AbstractConfiguration
{
    ...
    protected function loadXml($fieldXml)
    {
        ...
        try {
            ...
            $log = $this->registry->registry('stockimport_log');
            if ($log !== null) {
            ...
            if ($this->request && $this->request->getModuleName() == 'xtento_stockimport'
                && $this->request->getControllerName() == 'profile'
                && $this->request->getActionName() == 'edit'
            ) {
                $this->registry->register(
                    'stockimport_xml_' . $this->configurationType . '_warning',
