 ...
 * ID:            %!uniqueid!%
 * Last Modified: 2020-06-24T18:54:09+00:00
 * File:          Model/Source/Ftp.php
    ...
    public function loadFiles()
    {
        ...
        */
        if ($filelist === false || !is_array($filelist)) {
            ...
            $logEntry->addResultMessage(
                __(
                    'Source "%1" (ID: %2): Could not get file listing for import directory. You should try enabling Passive Mode in the modules FTP configuration. %3',
                    $this->getSource()->getName(),
                    $this->getSource()->getId(),
                    $warning
                )
