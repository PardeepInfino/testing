 ...
 * ID:            %!uniqueid!%
 * Last Modified: 2021-06-16T20:45:58+00:00
 * File:          Model/Import/Entity/Order.php
...
class Order extends AbstractEntity
{
    ...
    protected function loadOrder($rowIdentifier)
    {
        ...
        if ($orderIdentifier === 'order_ext_order_id') {
            $order = $this->orderFactory->create()->loadByAttribute('ext_order_id', strval($rowIdentifier));
        }
