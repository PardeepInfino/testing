...
class Profile extends \Magento\Rule\Model\AbstractModel
{
    ...
    public function beforeDelete()
    {
        ...
        $this->cronHelper->removeCronjobsLike('trackingimport_profile_' . $this->getId() . '\_%', \Xtento\TrackingImport\Cron\Import::CRON_GROUP);
        ...
        if ($this->getCronjobFrequency(
            ...
            foreach ($cronFrequencies as $cronFrequency) {
                ...
                $this->cronHelper->addCronjob(
                    ...
                    $cronFrequency,
                    $cronRunModel,
                    \Xtento\TrackingImport\Cron\Import::CRON_GROUP
                );
            }
        } else {
