 ...
 * ID:            %!uniqueid!%
 * Last Modified: 2022-11-15T22:07:10+00:00
...
abstract class AbstractMapping extends AbstractFieldArray
{
    ...
    public function __construct(
        ...
        )->setNameInLayout('xtento_trackingimport_profile_edit_mapping_importfields_' . $this->mappingId);
        ...
        if ($this->hasDefaultValueColumn) {
            ...
            )->setNameInLayout('xtento_trackingimport_profile_edit_mapping_defaultvalues_' . $this->mappingId);
    ...
    {
        $this->setNameInLayout('xtento_trackingimport_mapping_' . $this->mappingId);
