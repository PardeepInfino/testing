...
class DependenceTest extends \PHPUnit\Framework\TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->block = $this->getMockBuilder(Dependence::class)->disableOriginalConstructor()->getMockForAbstractClass();
        $this->setProperty($this->block, 'displayModeSource', $this->displayModeSource, Dependence::class);
    }
