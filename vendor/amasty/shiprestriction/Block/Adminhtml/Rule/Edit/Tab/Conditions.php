...
{
    public const FORM_NAME = 'amasty_ship_rule_form';
    ...
    protected function formInit($model)
    {
        ...
        $renderer = $this->rendererFieldset
            ->setTemplate('Amasty_CommonRules::ui/conditions/fieldset.phtml')
            ->setNameInLayout('amasty_commonrule_conditions')
            ->setFieldSetId(self::RULE_CONDITIONS_FIELDSET_NAMESPACE)
            ->setNewChildUrl(
                $this->getUrl(
