        ...
        if (null === $this->value) {
            ...
            foreach ($prices as $price) {
                ...
                if (false === $prevPrice || $this->isFirstPriceBetter($price['website_price'], $prevPrice)) {
                    $tierPrice = $prevPrice = isset($price['website_price'])?$price['website_price']:"";
                    $prevQty = isset($price['price_qty'])?$price['price_qty']:"";
                    $priceGroup = isset($price['cust_group'])?$price['cust_group']:"";
